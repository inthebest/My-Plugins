...
public plugin_init()
{
	register_plugin("Pusher SmokeGrenade", "0.1", "` BesTCore;");
	...
	bind_pcvar_num(create_cvar("PusherSmoke_Limit", "5", _, "Oyuncu sunucuya girince kac adet hak verilsin ?"), g_cvar);
}
